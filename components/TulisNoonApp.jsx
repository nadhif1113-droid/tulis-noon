...
function BelajarTab({ onSelectPath, onOpenGuru, progress }) {
  const paths = [
    ...
    { id: 'nahwu', title: 'Nahwu — Sintaksis Arab', arabic: 'النَّحْو', desc: '12 pelajaran · I\'rab, mubtada\', kaana, inna, hal, pasif', icon: BookOpen, color: '#0a4d3c', lessons: 12, available: true },
    { id: 'shorf', title: 'Shorf — Morfologi Arab', arabic: 'الصَّرْف', desc: '10 pelajaran · Tasrif, wazan mazid, mu\'tal, isim alat', icon: Sparkles, color: '#7a3d2a', lessons: 10, available: true },
  ];
