...
export const PERKENALAN_MATERI = [
  ...
  // ============================================================
  {
    ...
    vocab: [
      ...
      { ar: 'مَا اسْمُكَ؟', latin: 'مَا اسْمُكَ؟', id: 'Siapa namamu? (ke laki)' },
      { ar: 'مَا اسْمُكِ؟', latin: 'مَا اسْمُكِ؟', id: 'Siapa namamu? (ke perempuan)' },
    ...
    quiz: [
      { q: 'Bagaimana cara bilang "namaku Ahmad"?', options: ['اسْمِي أَحْمَدُ', 'أَنْتَ أَحْمَدُ', 'هُوَ أَحْمَدُ'], correctIdx: 0 },
      { q: 'Apa arti "مَا اسْمُكَ"?', options: ['Apa kabarmu?', 'Siapa namamu? (ke laki)', 'Dari mana asalmu?'], correctIdx: 1 },
      { q: 'Apa yang diucapkan setelah kenalan?', options: ['تَشَرَّفْنَا', 'مَعَ السَّلَامَة', 'شُكْرًا جَزِيلًا'], correctIdx: 0 },
      { q: 'Cara tanya nama ke perempuan?', options: ['مَا اسْمُكَ؟', 'مَا اسْمُكِ؟', 'مَا اسْمُهُ؟'], correctIdx: 1 },
    ],
  },
  {
    id: 'asal',
    ...
    vocab: [
      { ar: 'مِنْ أَيْنَ أَنْتَ؟', latin: 'مِنْ أَيْنَ أَنْتَ؟', id: 'Dari mana asalmu?' },
    ...
    dialog: [
      { speaker: 'A', ar: 'مِنْ أَيْنَ أَنْتَ؟', latin: 'مِنْ أَيْنَ أَنْتَ؟', id: 'Dari mana asalmu?' },
    ...
    quiz: [
      { q: 'Bagaimana cara tanya asal seseorang?', options: ['مَا اسْمُكَ؟', 'مِنْ أَيْنَ أَنْتَ؟', 'كَيْفَ حَالُكَ؟'], correctIdx: 1 },
      { q: 'Apa arti "أَنَا مِنْ إِنْدُونِيسِيَّا"?', options: ['Aku ke Indonesia', 'Aku dari Indonesia', 'Aku cinta Indonesia'], correctIdx: 1 },
      { q: 'Apa arti "مَدِينَتِي"?', options: ['Madinah', 'Kotaku', 'Negaraku'], correctIdx: 1 },
    ],
  },
  {
    id: 'umur',
    ...
    vocab: [
      { ar: 'كَمْ عُمْرُكَ؟', latin: 'كَمْ عُمْرُكَ؟', id: 'Berapa umurmu? (ke laki)' },
    ...
    dialog: [
      { speaker: 'A', ar: 'كَمْ عُمْرُكَ؟', latin: 'كَمْ عُمْرُكَ؟', id: 'Berapa umurmu?' },
    ...
    quiz: [
      { q: 'Bagaimana cara tanya umur?', options: ['كَمْ سَاعَة؟', 'كَمْ عُمْرُكَ؟', 'كَمْ ثَمَن؟'], correctIdx: 1 },
      { q: 'Apa arti "ثَلَاثُونَ"?', options: ['Tiga', 'Tigabelas', 'Tigapuluh'], correctIdx: 2 },
      { q: 'Apa arti "سَنَة"?', options: ['Bulan', 'Tahun', 'Hari'], correctIdx: 1 },
      { q: 'Cara bilang "umurku 40 tahun"?', options: ['عُمْرِي أَرْبَعُونَ سَنَة', 'عُمْرِي عِشْرُونَ سَنَة', 'عُمْرِي خَمْسُونَ سَنَة'], correctIdx: 0 },
    ],
  },
  {
    id: 'pekerjaan',
    ...
    vocab: [
      { ar: 'مَا مِهْنَتُكَ؟', latin: 'مَا مِهْنَتُكَ؟', id: 'Apa pekerjaanmu?' },
    ...
    dialog: [
      { speaker: 'A', ar: 'مَا مِهْنَتُكَ؟', latin: 'مَا مِهْنَتُكَ؟', id: 'Apa pekerjaanmu?' },
    ...
    quiz: [
      { q: 'Bagaimana cara tanya pekerjaan?', options: ['مَا مِهْنَتُكَ؟', 'مَا عُمْرُكَ؟', 'مَا اسْمُكَ؟'], correctIdx: 0 },
      { q: 'Apa arti "أَنَا طَبِيب"?', options: ['Aku guru', 'Aku dokter', 'Aku pedagang'], correctIdx: 1 },
      { q: 'Apa arti "مُتَقَاعِد"?', options: ['Insinyur', 'Mahasiswa', 'Pensiunan'], correctIdx: 2 },
    ],
  },
  ...
  // ============================================================
  {
    ...
    vocab: [
      ...
      { ar: 'زَوْجَتِي', latin: 'زَوْجَتِي', id: 'Istriku' },
      { ar: 'زَوْجِي', latin: 'زَوْجِي', id: 'Suamiku' },
      { ar: 'أَوْلَادِي', latin: 'awlādī', id: 'Anak-anakku' },
      { ar: 'أَخِي', latin: 'akhī', id: 'Saudaraku (lk)' },
      { ar: 'أُخْتِي', latin: 'أُخْتِي', id: 'Saudariku (pr)' },
      { ar: 'كَمْ وَلَد عِنْدَكَ؟', latin: 'كَمْ وَلَد عِنْدَكَ؟', id: 'Berapa anakmu?' },
    ],
    dialog: [
      { speaker: 'A', ar: 'كَمْ وَلَد عِنْدَكَ؟', latin: 'كَمْ وَلَد عِنْدَكَ؟', id: 'Berapa anakmu?' },
    ...
    quiz: [
      { q: 'Apa arti "أَبِي"?', options: ['Saudaraku', 'Ayahku', 'Anakku'], correctIdx: 1 },
      { q: 'Cara bilang "istriku"?', options: ['زَوْجِي', 'زَوْجَتِي', 'أُخْتِي'], correctIdx: 1 },
      { q: 'Apa arti "أَوْلَادِي"?', options: ['Saudaraku', 'Orangtuaku', 'Anak-anakku'], correctIdx: 2 },
      { q: 'Cara tanya jumlah anak?', options: ['كَمْ وَلَد عِنْدَكَ؟', 'كَمْ عُمْرُكَ؟', 'مِنْ أَيْنَ أَنْتَ؟'], correctIdx: 0 },
    ],
  },
  {
    id: 'pendidikan',
    ...
    dialog: [
      ...
      { speaker: 'B', ar: 'تَخَصُّصِي الْهَنْدَسَة', latin: 'تَخَصُّصِي الْهَنْدَسَة', id: 'Jurusanku teknik' },
    ],
    quiz: [
      { q: 'Apa arti "الْجَامِعَة"?', options: ['Sekolah', 'Universitas', 'Masjid'], correctIdx: 1 },
      { q: 'Cara bilang "jurusanku kedokteran"?', options: ['تَخَصُّصِي الطِّبّ', 'تَخَصُّصِي الْهَنْدَسَة', 'تَخَصُّصِي الْاِقْتِصَاد'], correctIdx: 0 },
      { q: 'Apa arti "تَخَرَّجْتُ"?', options: ['Aku masuk', 'Aku lulus', 'Aku belajar'], correctIdx: 1 },
    ],
  },
  {
    id: 'hobi',
    ...
    quiz: [
      { q: 'Apa arti "أُحِبّ"?', options: ['Aku punya', 'Aku suka', 'Aku perlu'], correctIdx: 1 },
      { q: 'Apa arti "السَّفَر"?', options: ['Memasak', 'Membaca', 'Bepergian'], correctIdx: 2 },
      { q: 'Cara bilang "hobiku sepak bola"?', options: ['هِوَايَتِي كُرَة الْقَدَم', 'هِوَايَتِي الْقِرَاءَة', 'هِوَايَتِي الطَّبْخ'], correctIdx: 0 },
    ],
  },
  {
    id: 'tujuan',
    ...
    vocab: [
      { ar: 'جِئْتُ لِلْعُمْرَة', latin: 'جِئْتُ لِلْعُمْرَة', id: 'Aku datang untuk umrah' },
      { ar: 'جِئْتُ لِلْحَجّ', latin: 'جِئْتُ لِلْحَجّ', id: 'Aku datang untuk haji' },
    ...
    quiz: [
      { q: 'Cara bilang "aku datang untuk umrah"?', options: ['جِئْتُ لِلْحَجّ', 'جِئْتُ لِلْعُمْرَة', 'جِئْتُ لِلزِّيَارَة'], correctIdx: 1 },
      { q: 'Apa arti "مَعَ عَائِلَتِي"?', options: ['Sendirian', 'Bersama keluargaku', 'Bersama teman'], correctIdx: 1 },
      { q: 'Bagaimana respons "تَقَبَّلَ اللَّهُ مِنْكُمْ"?', options: ['شُكْرًا', 'آمِين، وَمِنْكُمْ', 'مَعَ السَّلَامَة'], correctIdx: 1 },
      { q: 'Apa arti "أُسْبُوع"?', options: ['Hari', 'Minggu/seminggu', 'Bulan'], correctIdx: 1 },
    ],
  },
  {
    id: 'bahasa',
    ...
    vocab: [
      { ar: 'أَتَكَلَّم', latin: 'أَتَكَلَّم', id: 'Aku bicara' },
      ...
      { ar: 'قَلِيلًا', latin: 'قَلِيلًا', id: 'Sedikit' },
      { ar: 'بِطَلَاقَة', latin: 'بِطَلَاقَة', id: 'Lancar' },
      { ar: 'أَتَعَلَّم', latin: 'أَتَعَلَّم', id: 'Aku belajar' },
    ],
    dialog: [
    ...
    quiz: [
      { q: 'Apa arti "أَتَكَلَّم"?', options: ['Aku belajar', 'Aku bicara', 'Aku dengar'], correctIdx: 1 },
      { q: 'Cara bilang "lancar"?', options: ['قَلِيلًا', 'بِطَلَاقَة', 'سَرِيعًا'], correctIdx: 1 },
      { q: 'Cara bilang "aku sedang belajar"?', options: ['أَتَكَلَّم', 'أَتَعَلَّم', 'أَكْتُب'], correctIdx: 1 },
    ],
  },
  {
    id: 'kontak',
    ...
    vocab: [
      ...
      { ar: 'سَأُرْسِل لَكَ', latin: 'سَأُرْسِل لَكَ', id: 'Aku akan kirim untukmu' },
    ...
    quiz: [
      { q: 'Apa arti "رَقْم هَاتِفِي"?', options: ['Alamat rumahku', 'Nomor HP-ku', 'Email-ku'], correctIdx: 1 },
      { q: 'Cara bilang "aku akan kirim untukmu"?', options: ['سَأُرْسِل لَكَ', 'سَأَأْتِي لَكَ', 'سَأُعْطِيكَ'], correctIdx: 0 },
      { q: 'Apa arti "نَتَوَاصَل"?', options: ['Kita bertemu', 'Kita berpisah', 'Kita berkomunikasi'], correctIdx: 2 },
    ],
  },
  {
    id: 'status',
    ...
    vocab: [
      { ar: 'مُتَزَوِّج', latin: 'مُتَزَوِّج', id: 'Sudah menikah (lk)' },
      { ar: 'مُتَزَوِّجَة', latin: 'mutazawwijah', id: 'Sudah menikah (pr)' },
      { ar: 'أَعْزَب', latin: 'أَعْزَب', id: 'Belum menikah (lk)' },
      { ar: 'عَزْبَاء', latin: 'عَزْبَاء', id: 'Belum menikah (pr)' },
    ...
    quiz: [
      { q: 'Apa arti "مُتَزَوِّج"?', options: ['Pensiunan', 'Sudah menikah (lk)', 'Mahasiswa'], correctIdx: 1 },
      { q: 'Cara bilang "belum menikah (laki)"?', options: ['أَعْزَب', 'مُتَزَوِّج', 'عَزْبَاء'], correctIdx: 0 },
      { q: 'Apa arti "مُنْذُ عَشْر سَنَوَات"?', options: ['Sejak 10 hari', 'Sejak 10 bulan', 'Sejak 10 tahun'], correctIdx: 2 },
    ],
  },
  {
    id: 'jamaah-haji',
    ...
    vocab: [
      ...
      { ar: 'دَعَوْتُ لَكَ', latin: 'دَعَوْتُ لَكَ', id: 'Aku doakan kamu' },
    ...
    quiz: [
      { q: 'Apa arti "لِأَوَّل مَرَّة"?', options: ['Untuk pertama kali', 'Sekali saja', 'Kapan-kapan'], correctIdx: 0 },
      { q: 'Apa arti "حَجّ مَبْرُور"?', options: ['Haji bersama', 'Haji mabrur (diterima)', 'Haji sendirian'], correctIdx: 1 },
      { q: 'Cara bilang "aku doakan kamu"?', options: ['دَعَوْتُ لَكَ', 'أَتَمَنَّى لَكَ', 'شُكْرًا لَكَ'], correctIdx: 0 },
      { q: 'Apa arti "الرَّوْضَة"?', options: ['Pasar', 'Raudhah di Masjid Nabawi', 'Hotel'], correctIdx: 1 },
    ],
  },
];
