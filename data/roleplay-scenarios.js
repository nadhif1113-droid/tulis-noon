...
export const ROLEPLAY_SCENARIOS = [
  {
    ...
    description: 'Latihan tawar-menawar harga sama AI yang berperan jadi pedagang Saudi. Biar pas belanja kurma di pasar Madinah, kamu bisa nego dengan pede.',
    emoji: '🛍️',
    color: '#a05536',
  ...
  },
  {
    ...
    description: 'Latihan minta arah ke AI yang berperan jadi polisi Saudi. Biar kalau nyasar di Madinah/Mekkah, kamu bisa tanya pakai bahasa Arab dengan sopan.',
    emoji: '🚖',
    color: '#0a4d3c',
  ...
  },
  {
    ...
    description: 'Latihan pesan kopi Arab, kurma, & cari meja kosong di café Madinah. Biar pesan minuman tanpa awkward, ngobrolnya santai.',
    emoji: '☕',
    color: '#8b6b3d',
