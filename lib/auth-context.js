  ...
  async function createUserProfile(firebaseUser, additionalData = {}) {
    try {
      ...
      const profileData = {
        ...
        matchesPlayed: 0,
        matchesWon: 0,
        // Hafalan Quran Premium unlock — one-time 120 koin
        // Default false: user cuma punya akses Al-Fatihah + Juz 30 (38 surat)
        // Setelah unlock: akses semua 114 surat (30 juz penuh)
        hafalanFullUnlocked: false,
        // Perkenalan Diri Premium — bundle one-time 150 koin (lifetime + future materi)
        // ATAU per-materi 5 koin (id materi disimpan di array di bawah)
        perkenalanBundleUnlocked: false,
        unlockedPerkenalanMateri: [], // ['keluarga', 'hobi', ...] — materi yg dibuka per-piece
        // Progress tracking: completed materi ids (untuk progress bar)
