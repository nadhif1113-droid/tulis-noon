...
// JUARA 1 punya syarat extra: harus capai 4000 XP (GRAND_PRIZE_MIN_SCORE).
// Kalau tidak ada yang capai 4000 XP, hadiah Juara 1 di-rollover (admin discretion).
// Juara 2 & 3 = ranking biasa dari leaderboard (top scorer setelah Juara 1).
export const CHALLENGE_PRIZES = [
  {
    rank: 1, amount: 500000, label: 'Rp 500.000', emoji: '🥇',
    minScore: 4000, // grand prize threshold
    tagline: 'Butuh ≥ 4.000 XP — sang juara sejati',
  },
  {
    rank: 2, amount: 300000, label: 'Rp 300.000', emoji: '🥈',
    minScore: 500,
    tagline: 'Top 2 di leaderboard',
  },
  {
    rank: 3, amount: 200000, label: 'Rp 200.000', emoji: '🥉',
    minScore: 500,
    tagline: 'Top 3 di leaderboard',
  },
];
